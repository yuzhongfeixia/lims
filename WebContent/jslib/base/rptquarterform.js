Ext.define('gpersist.base.rptquarterform', {
	...
	OnBeforeFormLoad: function () {
      ...
      ' ', tools.GetToolBarCombo('SetQuarter', mep + 'SetQuarter', 120, '季度', 40, tools.GetQuarterStore(), 1),
	...
	OnBeforeSearch: function () {
		...
		me.plGrid.store.on('beforeload', function (store, options) {
			Ext.apply(store.proxy.extraParams, {
				...
				rptquarter: tools.GetValue(mep + 'SetQuarter')
			});
		});
	}
});