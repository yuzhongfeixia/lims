Ext.define('alms.devscrapaudit',{
  ...
  constructor:function(config){
    ...
    Ext.apply(config,{
      ...
      saveUrl:'DevSaveDevScrapAudit.do',
  ...
  OnBeforeCreateEdit:function(){
    ...
    me.editControls = [
      ...
      {xtype:'hiddenfield',name:'ds.auditdesc',id: mep + 'auditdesc'},
  ...
  OnCommit:function(){
    var me = this;
    var mep = me.tranPrefix;
    tools.SetValue(mep+'auditdesc',tools.GetValue(mep+'allowauditdesc'));
    me.OnSubmit();
  },
...
//    if(me.isPassed){
    me.editDetailControls = [
      tools.FormTextArea('审核意见', 'allowauditdesc', mep + 'allowauditdesc', 200, '100%', false, 18,6)
    ];
    me.disNews = [];
    me.disEdits = [];
    me.enNews = ['allowauditdesc'];
    me.enEdits = ['allowauditdesc'];
