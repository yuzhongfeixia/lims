Ext.define('alms.devscrapallow',{
  ...
  constructor:function(config){
    ...
    Ext.apply(config,{
      ...
      saveUrl:'DevSaveDevScrapAllow.do',
  ...
  OnBeforeCreateEdit:function(){
    ...
    me.editControls = [
      ...
      {xtype:'hiddenfield',name:'ds.devid',id: mep + 'devid'},
      ...
      {xtype:'hiddenfield',name:'ds.approvedesc',id: mep + 'approvedesc'},
      { xtype: 'label', id: mep + 'dsahtml', html: '' }
    ];
  },
  ...
  OnLoadData:function(item){
    ...
    Ext.getCmp(mep + 'dsahtml').update(html);
  ...
  OnAfterCreateEditToolBar:function(){
    ...
    var mep = me.tranPrefix;
    me.editToolItems = [
      '-', ' ', { id: mep + 'btnDown', text:'降级', iconCls: 'icon-deal', handler: me.OnDown, scope: me },
      '-', ' ', { id: mep + 'btnScrap', text:'报废', iconCls: 'icon-deal', handler: me.OnScrap, scope: me },
  ...
  OnDown:function(){
    ...
    tools.SetValue(mep+'flowaction','12');
    tools.SetValue(mep+'flowstatus','13');
    tools.SetValue(mep+'devstatus','02');
  },
  ...
  OnBack:function(){
    ...
    tools.SetValue(mep+'devstatus','00');
  },
  ...
  OnCommit:function(){
    var me = this;
    var mep = me.tranPrefix;
    tools.SetValue(mep+'approvedesc',tools.GetValue(mep+'allowapprovedesc'));
    me.OnSubmit();
  },
  ...
  OnCreateAllowWin:function(){
    ...
    me.editDetailControls = [
      tools.FormTextArea('审核意见', 'allowapprovedesc', mep + 'allowapprovedesc', 200, '100%', false, 18,6)
    ];
    
    me.disNews = [];
    me.disEdits = [];
    me.enNews = ['allowapprovedesc'];
    me.enEdits = ['allowapprovedesc'];
  ...
  OnShowDevScrap:function(item){
    ...
    html += '<tr class="infotr"><td class="infoat" align="center" width="10%">管理员</td>' +
    '<td class="infoc infoleft" align="left" width="15%">'+alms.GetItemData(devscrap.checkusername) +'</td>'+
    '<td class="infoat" align="center" width="10%">管理员时间</td>' +
    '<td class="infoc infoleft" align="left" width="15%">'+alms.GetItemDateData(devscrap.checkdate) +'</td>'+
    '<td class="infoat" align="center" width="10%">管理员意见</td>' +
    '<td class="infoc infoleft" colspan="3"  align="left" width="10%">'+alms.GetItemData(devscrap.checkdesc)+'</td></tr>';

    html += '<tr class="infotr"><td class="infoat" align="center" width="10%">鉴定负责人</td>' +
    '<td class="infoc infoleft" align="left" width="15%">'+alms.GetItemData(devscrap.auditusername) +'</td>'+
    '<td class="infoat" align="center" width="10%">鉴定部门</td>' +
    '<td class="infoc infoleft" align="left" width="15%">'+alms.GetItemData(devscrap.auditdeptname) +'</td>'+
    '<td class="infoat" align="center" width="10%">鉴定人时间</td>' +
    '<td class="infoc infoleft" colspan="3"  align="left" width="10%">'+alms.GetItemDateData(devscrap.auditdate)+'</td></tr>';
    ...
    html += '<tr class="infotr"><td class="infoat" align="center" width="10%">鉴定意见</td>' +
    '<td class="infoc  infoleft" colspan="7" align="left" width="10%">'+alms.GetItemData(devscrap.auditdesc) +'</td></tr>';
