...
//      
    ...
    CreateBottom:function(){
      ...
      var chart = Ext.create('Ext.ux.CCChartsComponent');
    ...
    OnServerCountyChart:function(){
      ...
      var customerinfo = tools.JsonGet('FormGetCustomerCount.do?cc.begindate='+begindate+'&cc.enddate='+enddate).data;
      var testednames = new Array();
      var counts = new Array();
      for(var i = customerinfo.length - 1; i >= 0; i--){
        testednames.push(customerinfo[i].testedname);
        counts.push(customerinfo[i].counts);
      }
      me.chart = tools.CustomerCount(nowyear,testednames,counts);
    },
