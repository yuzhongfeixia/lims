Ext.define('alms.testerparameter', {
...
//      
    ...
    CreateBottom:function(){
      ...
      var lschart = Ext.create('Ext.ux.TPChartsComponent');
    ...
    OnTesterChart:function(){
      ...
      var testers = tools.JsonGet('FormGetTesterParameter.do?tp.deptid='+deptid+'&tp.begindate='+begindate+'&tp.enddate='+enddate).data;
      ...
      for(var i = 0; i < testers.length; i++){
        ...
        paratotals += testers[i].testercount;
      }

      me.lschart = tools.TesterParameter(titledata,testerdata,paratotals);
    },
