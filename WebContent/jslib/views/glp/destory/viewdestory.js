Ext.define('alms.viewdestory', {
  extend: 'gpersist.base.busform',
  
  constructor: function (config) {
    var me = this;
    Ext.apply(config, {
      editinfo: 'GLP文件销毁记录查看',
  ...
  OnBeforeCreateEdit: function () {
    ...
    me.editControls = [
      ...
      {xtype:'hiddenfield',name:'gfd.tranid',id: mep + 'tranid'}
    ];
...
//  },
  ...
  OnShow:function(){
    var me = this;
    var mep = me.tranPrefix;
    var record = tools.OnGridLoad(me.plGrid, '请选择查看数据！');
    if (!record) 
      return;
  ...
  ShowDestoryApplyHtml: function(record){
    var destoryapply = tools.JsonGet('GlpGetGlpFileDestroyRecord.do?gfdr.tranid='+record.tranid);
    
    var html = '<table align="center" cellspacing="0" cellpadding="0" border="0" style="font-size:12px;" width="80%">';
    html += '<tr class="infotrheader"><td colspan="8" align="center" width="100%" style="height: 40px;font-size:20px"><b>GLP文件销毁记录查看</b></td></tr>';
