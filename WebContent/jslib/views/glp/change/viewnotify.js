...
//        ' ', { id: mep + 'btnPrint', text: gpersist.STR_BTN_PRINT, iconCls: 'icon-print', handler: me.OnPrint, scope: me },
  ...
  OnShowGetHtml:function(item){
    ...
    var mep = me.tranPrefix;
    var height = 40;
    var record = tools.JsonGet('GlpGetGlpFileNotify.do?gfn.tranid='+item.tranid);
    
    var html = '<table align = "center" cellspacing="0" cellpadding="0" border="0" style="font-size:12px;" width="80%">';
    html += '<tr class="infotrheader"><td colspan="8" align="center" width="100%" style="height: 40px;font-size:20px"><b>GLP文件更改通知</b></td></tr>';
