Ext.define('alms.manmyapply', {
  ...
  constructor: function (config) {
    ...
    Ext.apply(config, {
      ...
      storeUrl: 'FlowSearchMyApply.do',
      expUrl: 'FlowSearchMyApply.do',
      hasPage: true,
      idPrevNext: 'tranid',
      hasDateSearch: true,
      busflow: 'devapply',
...
//  },
  ...
  OnSetData: function (id, record) {
    ...
    var businfo = tools.HtmlGet(flow.htmldatafunction + '.do?tranid=' + tools.GetEncode(tools.GetEncode(Ext.getCmp(mep + 'tranid').getValue())));
    businfo = businfo || '';
