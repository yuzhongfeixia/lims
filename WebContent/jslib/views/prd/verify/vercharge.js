Ext.define('alms.vercharge',{
   ...
   constructor:function(config){
      ...
      Ext.apply(config,{
          ...
          saveUrl:'PrdSavePrdVerifyCharge.do',
   ...
   OnBeforeCreateEdit:function(){
     ...
     me.editControls = [
      ...
      {xtype:'hiddenfield',name:'prdverify.comfirmdesc',id: mep + 'comfirmdesc'},
     ...
     if(me.gridStore){
       me.gridStore.on('beforeload',function(store,options){
         Ext.apply(store.proxy.extraParams,{
           'prdverify.flowstatus':'05',
           'prdverify.flowaction':'05'
         });
       });
     }
   },
  ...
  OnCreateEditWin : function() {
   ...
   OnPass:function(){
      ...
      tools.SetValue(mep+'flowstatus','21');
   },
   ...
   OnBack:function(){
      ...
      tools.SetValue(mep+'flowstatus','22');
   },
   ...
   OnCommit:function(){
      var me = this;
      var mep = me.tranPrefix;
      tools.SetValue(mep+'comfirmdesc',tools.GetValue(mep+'appcomfirmdesc'));
      me.OnSubmit();
   },
  ...
  OnAfterShow:function(record){
   ...
   OnCreateApproveWin:function(){
      ...
      me.editDetailControls = [
       tools.FormTextArea('审核意见', 'comfirmdesc', mep + 'appcomfirmdesc', 200, '100%', false, 18,6)
      ];
      
      me.disNews = [];
      me.disEdits = [];
      me.enNews = ['appcomfirmdesc'];
      me.enEdits = ['appcomfirmdesc'];
