Ext.define('alms.verdirector',{
   ...
   constructor:function(config){
      ...
      Ext.apply(config,{
          ...
          saveUrl:'PrdSavePrdVerifyDirector.do',
   ...
   OnBeforeCreateEdit:function(){
     ...
     me.editControls = [
      ...
      {xtype:'hiddenfield',name:'prdverify.checkdesc',id: mep + 'checkdesc'},
     ...
     if(me.gridStore){
       me.gridStore.on('beforeload',function(store,options){
         Ext.apply(store.proxy.extraParams,{
           'prdverify.flowstatus':'21',
           'prdverify.flowaction':'04'
         });
       });
     }
   },
  ...
  OnCreateEditWin : function() {
   ...
   OnPass:function(){
      ...
      tools.SetValue(mep+'flowstatus','09');
   },
