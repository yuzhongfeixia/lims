Ext.define('alms.prdoffice',{
   ...
   constructor:function(config){
      ...
      Ext.apply(config,{
          ...
          saveUrl:'PrdSavePrdApplyOffice.do',
   ...
   OnBeforeCreateEdit:function(){
     ...
     me.editControls = [
      ...
      {xtype:'hiddenfield',name:'prdapply.auditdesc',id: mep + 'auditdesc'},
     ...
     if(me.gridStore){
       me.gridStore.on('beforeload',function(store,options){
         Ext.apply(store.proxy.extraParams,{
           'prdapply.flowstatus':'02',
           'prdapply.flowaction':'02'
         })
       });
     }
   },
   ...
   OnBeforeSave:function(){
    var me = this;
    var mep = me.tranPrefix;
    var prdsource = tools.GetValue(mep+'appprdsource');
    if(prdsource ==gpersist.SELECT_MUST_VALUE  && me.isPassed){
       tools.alert('请选择耗材招标！');
        return;
    }
    return true;
  ...
  OnCreateEditWin : function() {
   ...
   OnCommit:function(){
      ...
      var mep = me.tranPrefix;
      if(me.isPassed){
        tools.SetValue(mep+'prdsource',tools.GetValue(mep+'appprdsource'));
      }
   ...
   OnCreateApproveWin:function(){
      ...
      if(me.isPassed){
         me.editDetailControls = [
           tools.FormCombo('耗材招标', 'prdsource', mep + 'appprdsource', tools.ComboStore('PrdSource', gpersist.SELECT_MUST_VALUE), '50%', false, 7),
      ...
      me.disNews = [];
      me.disEdits = [];
      me.enNews = ['appprdsource','appauditdesc'];
      me.enEdits = ['appprdsource','appauditdesc'];
