Ext.define('alms.stkin',{
   ...
   OnBeforeCreateEdit:function(){
     ...
     me.disEdits = ['recouser', 'storeid','recousername','tranid'];
     ...
     me.editDetailControls = [
       {xtype: 'container', anchor: '100%', layout: 'column', items: [
         {xtype: 'container', columnWidth: .5, layout: 'anchor', items: [
            prdname,
            tools.FormText('入库数量', 'detail.prdnumber', mep + 'prdnumber',4, '96%', false, 22,'is12p2',90),
//            tools.FormText('单位数量', 'detail.unitnumber', mep + 'unitnumber',4, '96%', true, 24,'is12p2',90),
            tools.FormText('入库单价(元)', 'detail.prdprice', mep + 'prdprice',6, '96%', false, 21,'is12p2',90),
            ...
            tools.FormCombo('入库人', 'detail.buyuser', mep + 'buyuser', tools.ComboStore('User', gpersist.SELECT_MUST_VALUE), '96%', true,29,90),
         ...
         {xtype: 'container', columnWidth: .5, layout: 'anchor', items: [
            ...
            tools.FormCombo('计量单位', 'detail.prdunit', mep + 'prdunit', tools.ComboStore('PrdUnit',gpersist.SELECT_MUST_VALUE), '100%', true,29,90),
//            tools.FormText('入库总数', 'detail.factnumber', mep + 'factnumber',12, '100%', true, 23,'is12p2',90),
     ...
     me.enDetailControls = ['prdcodeprefix', 'prdname','prdid', 'prdnumber', 'prdprice', 'unitnumber', 'tradeid','tradename', 
                            'factoryname', 'factorydate', 'validdate', 'buyuser', 'buyusername', 'buydate', 'detailremark','prdunit','prdtype','prdamount',
   ...
   OnPrdSelect:function(render,item){
     ...
     if(item){
        ...
        tools.SetValue(mep+"validdate",item.validmonth);
