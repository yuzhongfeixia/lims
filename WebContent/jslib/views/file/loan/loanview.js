Ext.define('alms.loanview', {
  ...
  OnBeforeCreateEdit: function () {
    ...
    me.editControls = [
      ...
      {xtype:'hiddenfield',name:'la.tranid',id: mep + 'tranid'}
    ];
...
//  },
  OnBeforeSearch: function () {
    ...
    if (me.gridStore) {
      me.gridStore.on('beforeload', function (store, options) {      
        Ext.apply(store.proxy.extraParams, {
          'la.fileid': tools.GetEncode(tools.GetValue(mep + 'searchfileid')),
  ...
  ShowLoanApplyHtml: function(record){
    var loanapply = tools.JsonGet('IncFileGetLoanApply.do?la.tranid='+record.tranid);
    
    var html = '<table align="center" cellspacing="0" cellpadding="0" border="0" style="font-size:12px;" width="80%">';
    html += '<tr class="infotrheader"><td colspan="8" align="center" width="100%" style="height: 40px;font-size:20px"><b>文件借阅申请查看</b></td></tr>';
    
    html += '<tr class="infotr"><td class="infoat" align="center" width="10%">销毁编号</td>' +
      '<td class="infoc infoleft" align="left" width="15%">' +alms.GetItemData(loanapply.tranid)+ '</td>' +
      '<td class="infoat" align="center" width="10%">文件编号</td>' +
      '<td class="infoc infoleft" align="left" width="15%">'+alms.GetItemData(loanapply.fileid)+'</td>'+
      '<td class="infoat" align="center" width="10%">文件名称</td>' +
      '<td class="infoc infoleft" align="left" width="15%">'+alms.GetItemData(loanapply.filename)+'</td>'+
      '<td class="infoat" align="center" width="10%">借阅时间</td>' +
      '<td class="infoc infoleft" align="left" width="15%">'+alms.GetItemDateData(loanapply.loandate)+'</td></tr>';
    
    html += '<tr class="infotr"><td class="infoat" align="center" width="10%">归还时间</td>' +
      '<td class="infoc infoleft" colspan=7 align="left" width="15%">' +alms.GetItemDateData(loanapply.returndate)+ '</td></tr>';
    
    html += '<tr class="infotr"><td class="infoat" align="center" width="10%">备注</td>' +
      '<td class="infoc infoleft" colspan=7  align="left" width="90%">'+alms.GetItemData(loanapply.remark)+'</td></tr>';
