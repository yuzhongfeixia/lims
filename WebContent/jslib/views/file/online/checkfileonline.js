Ext.define('alms.checkfileonline', {
  ...
  constructor: function (config) {
    ...
    Ext.apply(config, {
      ...
      saveUrl: 'IncFileCheckIncFileOnline.do',
  ...
  OnBack: function(){
    ...
    if(record){
      Ext.Msg.confirm(gpersist.CONFIRM_TITLE, '确定驳回申请', function(btn) {
        if (btn == 'yes') {
            Ext.Ajax.request({
                url: 'IncFileUnCheckIncFileOnline.do',
  ...
  OnNew:function(){
    ...
    var record = tools.OnGridLoad(me.plGrid, '请选择需要授权的文件申请！');
