Ext.define('alms.manborrowed', {
  ...
  constructor: function (config) {
    ...
    Ext.apply(config, {
      ...
      expUrl: 'IncFileSearchIncFileRegisterForExp.do?ifr.isreturn=true',
      hasPage: true,
      hasPrevNext: true,
      idPrevNext: 'tranid',
      hasGridSelect: true
  ...
  OnBeforeCreateEdit: function () {
    ...
    me.editControls = [
          {xtype:'hiddenfield',name:'ifr.tranid',id: mep + 'tranid'},
...
//      tools.alert('未申请在线阅读');
//    }else{
//      var file = tools.JsonGet('IncFileGetBasFile.do?bf.fileid='+record.fileid);
//      
//      if(file && file.fileid){
    ...
    if (me.gridStore) {
      me.gridStore.on('beforeload', function (store, options) {      
        Ext.apply(store.proxy.extraParams, {
          ...
          'ifr.userid': tools.GetEncode(gpersist.UserInfo.user.userid),
          'type': 'hasread'
        });
      });
    };
