Ext.define('gpersist.setuserdept', {
  ...
  OnBeforeCreateEdit: function () {
    ...
    var leftStore = tools.CreateGridStore(tools.GetUrl('UserGetUnSetUserDept.do'), rightfields);
    var rightStore = tools.CreateGridStore(tools.GetUrl('UserGetSetUserDept.do'), rightfields);
