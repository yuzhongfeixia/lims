Ext.define('gpersist.setrole', {
  ...
  constructor: function (config) {
    ...
    Ext.apply(config, {
      ...
      saveUrl: gpersist.ACTION_ROLE_SERSAVE,
      hasAutoLoad: false,
      hasPage: true,
      hasPrevNext: true
    });
  ...
  OnBeforeCreateEdit: function () {
    ...
    var rightcols = [];
    var rightfields = [];
    tools.GetGridColumns('p_set_role', leftcols, leftfields, mep + '_left_');
    tools.GetGridColumns('p_set_role', rightcols, rightfields, mep + '_right_');

    var leftStore = tools.CreateGridStore(tools.GetUrl(gpersist.ACTION_ROLE_UNSET), rightfields);
    var rightStore = tools.CreateGridStore(tools.GetUrl(gpersist.ACTION_ROLE_SET), rightfields);
  ...
  OnGetSaveParams: function () {
    ...
    me.saveParams = {setroles: Ext.encode(json)};
  }
});