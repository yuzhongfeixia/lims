Ext.define('alms.manstdreview',{
  ...
  constructor:function(config){
    ...
    Ext.apply(config, {
      ...
      storeUrl:'StdSearchStdReview.do',
      saveUrl:'StdSaveStdReview.do',
      expUrl:'StdSearchStdReview.do',
      hasPage: true,
      hasPrevNext: true,
      idPrevNext: 'tranid',
      hasSubmit: true,
  ...
  OnBeforeCreateEdit: function () {
    ...
    me.editControls=[
                     { xtype: 'container', anchor: '100%', layout: 'column', items: [
                      ...
                      tools.FormTextArea('变更描述', 'sr.reviewdesc', mep + 'reviewdesc',  50, '100%',true,7,2),
