Ext.define('alms.editprovgetdetail', {
      ...
      { xtype: 'container', anchor: '100%', layout: 'column', items: [
        { xtype: 'container', columnWidth: .7, layout: 'anchor', items: [
          { xtype: 'container', anchor: '100%', layout: 'column', items: [
            ...
            { xtype: 'container', columnWidth: .5, layout: 'anchor', items: [
               tools.FormText('样品来源', 'samplesource', mep + 'samplesource', 20, '96%', false,23)
            ]}
          ]},
          ...
          tools.FormTextArea('备注', 'remark', mep + 'remark', 200, '98%', false, 29, 4),
...
//           tools.FormText('抽样量', 'samplecount', mep + 'samplecount', 20, '100%', false,23)
//        ]}
//      ]},
//      tools.FormTextArea('抽样地点', 'getaddr', mep + 'getaddr', 200, '100%', false, 29,2),
//      tools.FormTextArea('备注', 'remark', mep + 'remark', 200, '100%', false, 29, 2),
//      {xtype:'hiddenfield',name:'sampleid',id: mep + 'sampleid'},
//      {xtype: 'container', anchor: '100%', layout: 'column', items: [
...
//      ]}
    ...
    me.disNews = [];
    me.disEdits = [];
    me.enNews = ['sampleid','samplename','samplesource','samplecount','getaddr','samplestatus','remark']; 
    me.enEdits = ['sampleid','samplename','samplesource','samplecount','getaddr','samplestatus','remark'];
    ...
    if (tools.InvalidForm(me.plEdit.getForm())) { 
      ...
      if(tools.GetValue(mep + 'sampleid') == ''){
        ...
        var data = {
          ...
          samplesource: tools.GetValue(mep + 'samplesource'),
