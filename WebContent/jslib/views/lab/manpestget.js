Ext.define('alms.manpestget', {
  ...
  constructor: function (config) {
    ...
    Ext.apply(config, {
      ...
      saveUrl: 'LabSaveBusGetPest.do',
      expUrl: 'LabSearchBusGet.do',
      urlDetailColumn: 'SysSqlColumn.do?sqlid=p_get_pestgetdetail',
  ...
  OnBeforeCreateEdit: function () {
    ...
    var getnotice = Ext.create('Ext.ux.GridPicker', {
      ...
      storeUrl: 'LabSearchBusGetNoticeForGet.do?bgn.gettype=03',
      editable:false,
  ...
  OnListNew : function(){
    ...
    me.getdetail = tools.GetPopupWindow('alms', 'editpestgetdetail', 
  ...
  OnDetailSave: function (e, data) {
    ...
    record.data.standcode = data.standcode;
    ...
    record.data.allowcode = data.allowcode;
  ...
  OnView: function () {
    ...
    me.winpreview.OnSetData('000009',tranid,'03');
  },
