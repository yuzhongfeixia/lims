Ext.define('alms.labreportaudit', {
  ...
  constructor : function(config) {
    ...
    Ext.apply(config, {
      ...
      storeUrl : 'DatSearchBusReportAduit.do',
  ...
  OnAfterCreateEditToolBar : function() {
    ...
    me.editToolItems =
      ...
      // ' ', { id : mep + 'btnBackUp', text : '申领备份样', iconCls : 'icon-deal',
      // handler : me.OnBackUp, scope : me },
      // ' ', { id: mep + 'btnPrintRecord', text: '打印试验报告', iconCls:
      // 'icon-print', handler: me.OnPrintRecord, scope: me },
      '-',' ',{
  ...
  OnPass : function() {
    ...
    if (reportstatus == '06' || reportstatus == '10') {
      tools.alert('该样品试验报告已被驳回修改，不能进行审核操作.......');
      return false;
    }
    
    if (reportstatus == '12') {
      tools.alert('该样品试验报告已打印完成，不能进行审核操作.......');
      return false;
    }
  ...
  OnCreateDetailWinCheck : function() {
    ...
    var items =
      [' ',{
        id : mep + 'btnDetailSave',
        text : '提交',
        iconCls : 'icon-save',
        handler : me.OnCommit,
        scope : me
      },'-',' ',{
        id : mep + 'btnDetailClose',
        text : gpersist.STR_BTN_CLOSE,
        iconCls : 'icon-close',
        handler : function() {
          me.winDetail.hide();
    ...
    me.editDetailControls =
      [tools.FormTextArea('', 'modifydesc', mep + 'wincheckdesc', 200, '100%', true, 18, 12)];
  ...
  OnSubmit : function() {
    ...
    me.OnGetSubmitParams();
    
    if (tools.InvalidForm(me.plEdit.getForm())) {
      
      me.plEdit.form.submit({
        clientValidation : false,
        url : tools.GetUrl('DatAuditBusReport.do'),
...
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle">&emsp;&emsp;&emsp;&emsp;l、报告无 ”检验检测专用章” 或检验检测单位公章无效。</td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle">&emsp;&emsp;&emsp;&emsp;2、复制报告未重新加盖”检验检测专用章” 或检验检测单位公章无效。</td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle">&emsp;&emsp;&emsp;&emsp;3、报告无制表、审核、批准人签单无效。</td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle">&emsp;&emsp;&emsp;&emsp;4、报告涂改无效。</td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle">&emsp;&emsp;&emsp;&emsp;5、对检验检测报告若有异议，应于收到报告之日起十五日内向检验检测单位提出。</td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle">&emsp;&emsp;&emsp;&emsp;6、客户送样委托检验， 仅对来样负责。</td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle">&emsp;&emsp;&emsp;&emsp;7、未经本中心同意， 该检验检测报告不得用于商业宣传。</td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      
...
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle">&emsp;&emsp;&emsp;&emsp;地 址： 南京市草场门大街124号江苏农业检测大楼</td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle">&emsp;&emsp;&emsp;&emsp;电 话 ( Tel )   : (025) 86263563 &emsp;&emsp;&emsp;&emsp;传 真(Fax) : (025) 86229784</td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle"></td></tr>';
//      doublehtml += '<tr><td width="936px" height="27px" style="font-weight:bold; font-family:FangSong;font-size:15px;" colspan="26" align="left" valign="middle">&emsp;&emsp;&emsp;&emsp;邮政编码 ( Postcode) : 210036</td></tr>';
//      
//      doublehtml += '</table>';
//      for (var n = 0; n < records.data.length; n++) {
//        var item = tools.JsonGet(tools.GetUrl('DatGetSetBusReport.do?breport.reportid=') + tools.GetEncode(tools.GetEncode(records.data[n].reportid)));
...
//                    if (record.isbold)
//                      style += 'font-weight:bold;';
//                    if (record.fontsize == 24)
//                      style += ' font-family:FZYaoti;';
//                    if (record.fontsize == 28)
//                      style += ' font-family:KaiTi;';
//                    if (record.fontsize == 50)
//                      style += ' font-family:STZhongsong;';
//                    if (record.fontsize == 17)
//                      style += ' font-family:SimSun;';
//                    if (record.fontsize == 16)
//                      style += ' font-family:KaiTi_GB2312;';
//                    if (record.fontsize == 14)
//                      style += ' font-family:SimSun;';
//                    
//                    style += 'font-size:' + record.fontsize + 'px;';
//                    
...
//                          form += cellhtml;
//                      } else if (Ext.isEmpty(record.classsource)) {
//                        form += '<td width="' + nowwidth + 'px" height="' + nowheight + 'px" border="0" ' + (rowspan == 1 ? '' : 'rowspan ="' + rowspan + '" ') + (colspan == 1 ? '' : 'colspan ="' + colspan + '" ') + align + ' valign="middle">' + '<image width="' + nowwidth + 'px" height="' + nowheight + 'px" src="images/sign/' + record.fieldcode + '.jpg" /></td>';
//                      } else if (!Ext.isEmpty(celltext)) {
//                        form += '<td width="' + nowwidth + 'px" height="' + nowheight + 'px" border="0" ' + (rowspan == 1 ? '' : 'rowspan ="' + rowspan + '" ') + (colspan == 1 ? '' : 'colspan ="' + colspan + '" ') + align + ' valign="middle">' + '<image height="' + nowheight + 'px" src="images/sign/' + celltext + '.jpg" /></td>';
//                      } else
//                        form += cellhtml;
//                    } else {
//                      form += cellhtml;
...
//      me.disphtml += form.replace(/\<br \/\>/g, '');
//      
//      var html = '<table cellspacing="0" cellpadding="0" border="0" style="width:98%;">' + '<tr><td align="center">' + form + '</td></tr></table>';
//      Ext.fly(Ext.getCmp(mep + 'busreporthtml').getEl()).update(html);
//      
//      me.OnDetailRefresh();
//      
...
//  },
  ...
  OnBeforeSave : function() {
    ...
    if (datadeal == '10') {
      tools.SetValue(mep + 'reportstatus', '08');
    } else if (datadeal == '11') {
      tools.SetValue(mep + 'reportstatus', '10');
    }
