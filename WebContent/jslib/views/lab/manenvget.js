Ext.define('alms.manenvget', {
  ...
  OnBeforeCreateEdit: function () {
    ...
    var getnotice = Ext.create('Ext.ux.GridPicker', {
      ...
      storeUrl: 'LabSearchBusGetNoticeForGet.do?bgn.gettype=04',
      editable:false,
    ...
    me.editControls = [      
      ...
      { xtype: 'container', anchor: '100%', layout: 'column', items: [
        ...
        { xtype: 'container', columnWidth: .25, layout: 'anchor', items: [
          tools.FormText('基地名称', 'bg.basename', mep + 'basename', 10, '96%', true,3,null,90),
          tools.FormText('受检者', 'bg.testeduser', mep + 'testeduser', 300, '96%', true,3,null,90)
        ]},
        { xtype: 'container', columnWidth: .25, layout: 'anchor', items: [
    ...
    me.enNews = ['noticeid','entermanager','tranremark','testeduser','trustdept','prdstand',
                 ...
                 'tasksource','sendtype','planvar','testedname','enterlegal','entertele','enterpost','testtype',
  ...
  OnListNew : function(){
    ...
    me.getdetail = tools.GetPopupWindow('alms', 'editenvgetdetail', 
  ...
  OnView: function () {
    ...
    me.winpreview.OnSetData('000010',tranid,'04');
  },
