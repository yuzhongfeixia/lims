Ext.define('alms.manpollget', {
  ...
  constructor: function (config) {
    ...
    Ext.apply(config, {
      ...
      saveUrl: 'LabSaveBusGetPoll.do',
      expUrl: 'LabSearchBusGet.do',
      urlDetailColumn: 'SysSqlColumn.do?sqlid=p_get_pollgetdetail',
  ...
  OnBeforeCreateEdit: function () {
    ...
    var getnotice = Ext.create('Ext.ux.GridPicker', {
      ...
      storeUrl: 'LabSearchBusGetNoticeForGet.do?bgn.gettype=05',
      editable:false,
    ...
    me.editControls = [      
      { xtype: 'container', anchor: '100%', layout: 'column', items: [
        ...
        { xtype: 'container', columnWidth: .25, layout: 'anchor', items: [
          ...
          tools.FormText('受检者', 'bg.testeduser', mep + 'testeduser', 200, '100%', true,3,null,90)
        ]}
      ]},
  ...
  OnListNew : function(){
    ...
    me.getdetail = tools.GetPopupWindow('alms', 'editpollgetdetail', 
      {mid:me.mid, tranPrefix:me.tranPrefix, childPrefix: 'pgd', dataDeal: gpersist.DATA_DEAL_NEW})
  ...
  OnListSelect: function(e, record, item, index) {
    ...
    me.getdetail = tools.GetPopupWindow('alms', 'editpollgetdetail', 
      {mid:me.mid, tranPrefix:me.tranPrefix, childPrefix: 'pgd', dataDeal: me.dataDeal})
    me.getdetail.on('formlast', me.OnDetailSave, me);
    me.getdetail.OnFormLoad();
  ...
  OnView: function () {
    ...
    me.winpreview.OnSetData('000001',tranid,'05');
  },
