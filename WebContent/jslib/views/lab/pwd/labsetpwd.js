Ext.define('alms.labsetpwd', {
  ...
  constructor : function(config) {
    ...
    Ext.apply(config, {
      ...
      winWidth: 500,
      winHeight: 150,
      saveUrl: 'LabSaveSignerPassword.do'
    });
  ...
  OnSavePasswd: function () {
    ...
    if (tools.GetValue(mep + 'signer_passwd') != tools.GetValue(mep + 'signer_repasswd')) {
      tools.alert(gpersist.STR_ERR_CHANGE_PASSWD1);
      return;
    }
    
//    if (!tools.CheckPasswd(tools.GetValue(mep + 'signer_passwd'))) {
