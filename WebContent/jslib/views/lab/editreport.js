...
//              tools.FormText('第一页与第二页间距', 'redetail.prefixtext', mep + 'prefixtext', 10, '96%', true, 17),
...
//              tools.FormText('第二页与第三页间距', 'redetail.postfixtext', mep + 'postfixtext', 10, '100%', true, 18)
        ...
        me.disDetailControls = ['cellserial','celltext'];
        me.enDetailControls = [ 'beginrow', 'endrow', 'begincolumn', 'endcolumn', 'cellname', 'valuesource', 
          'valuetype', 'classsource', 'fieldcode', 'groupserial', 'specserial',  'cellformat', 'isborder', 'isline', 
          'isbold', 'ismutil', 'fontsize', 'aligntype','fonttype','formserial'];
      },
