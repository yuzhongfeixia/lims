Ext.define('alms.approvebusrecord', {
  ...
  constructor: function (config) {
    ...
    Ext.apply(config, {
      ...
      storeUrl: 'DatSearchBusRecordApprove.do',
      saveUrl: 'DatApproveBusRecord.do',
      expUrl: 'DatSearchBusRecordApprove.do',
  ...
  OnBeforeFormLoad: function () {
    ...
    var items = [
      ...
      '-', { id: mep + 'btnEdit', text: '复核', iconCls: 'icon-deal', handler: me.OnEdit, scope: me },
  ...
  OnBeforeCreateEdit: function () {
    ...
    me.editControls = [
      ...
      {xtype:'hiddenfield',name:'br.tranuser',id: mep + 'tranuser'},
  ...
  OnBackCreatePrompt: function(){
    ...
    if (!me.winPrompt) {
      me.winPrompt = Ext.create('Ext.window.Window', {
        ...
        buttons: [{ text: gpersist.STR_BTN_SUBMIT, id: mep +  'btnSavePassword', handler: me.OnBackSave, scope: me },
  ...
  OnCommitCreatePrompt: function(){
    ...
    if (!me.winPrompt) {
      me.winPrompt = Ext.create('Ext.window.Window', {
        ...
        closeAction: 'hide', border: false,
        items: [me.plwinPrompt],
        buttons: [{ text: gpersist.STR_BTN_SUBMIT, id: mep +  'btnSavePassword', handler: me.OnCommitSave, scope: me },
                  { text: gpersist.STR_BTN_CLOSE, handler: function () { me.winPrompt.hide(); } }]
      });
    }
  },
...
//          Ext.getCmp(mep + 'checkwin').hide();
  ...
  OnCommitGetSaveParams : function() {
    var me = this;
    var mep = me.tranPrefix;
    me.saveParams = {signerpassword: Ext.getCmp(mep + 'signer_passwd').getValue(), auditusers: Ext.getCmp(mep + 'audituser').getValue() };
  },
  OnBackGetSaveParams : function() {
    var me = this;
    var mep = me.tranPrefix;
    me.saveParams = {signerpassword: Ext.getCmp(mep + 'signer_passwd').getValue(), auditusers: '驳回' };
  },
//  OnBackGetSaveParams : function() {
//    var me = this;
//    var mep = me.tranPrefix;
...
//  },
  ...
  OnLoadData: function (record) {
    ...
    tools.SetValue(mep + 'tranuser', record.tranuser);
