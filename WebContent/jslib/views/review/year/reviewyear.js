Ext.define('alms.reviewyear', {
    ...
    me.editControls = [
      { xtype: 'container', anchor: '100%', layout: 'column', items: [
        { xtype: 'container', columnWidth: .5, layout: 'anchor', items: [
          tools.FormText('计划编号', 'rr.tranid', mep + 'tranid', 20, '96%', false, 1)
        ]},
        { xtype: 'container', columnWidth: .5, layout: 'anchor', items: [
          tools.FormText('评审目的', 'rr.reviewgoal', mep + 'reviewgoal', 50, '100%', false, 3),
          {xtype:'hiddenfield',name:'rr.deal.action',id: mep + 'datadeal'}
        ]}
      ]},
      tools.FormTextArea('评审组成员', 'rr.reviewcrew', mep + 'reviewcrew', 50, '100%', false, 5,2),
      tools.FormTextArea('评审日期安排', 'rr.reviewplan', mep + 'reviewplan', 200, '100%', true, 9, 9),
      tools.FormTextArea('评审要点', 'rr.reviewgist', mep + 'reviewgist', 200, '100%', true, 10, 9)
    ];
    me.disNews = ['tranid'];
    me.disEdits = ['tranid'];
    me.enNews = ['reviewcrew','reviewgoal','reviewplan','reviewgist'];
    me.enEdits = ['reviewcrew','reviewgoal','reviewplan','reviewgist'];
  },
  ...
  OnLoadData: function (item) {
    ...
    if(item && !Ext.isEmpty(item.tranid)){
      ...
      tools.SetValue(mep + 'reviewcrew', item.reviewcrew);
      tools.SetValue(mep + 'reviewplan', item.reviewplan);
      tools.SetValue(mep + 'reviewgist', item.reviewgist);
      return true;
    } else{
