...
public class GlpFileChange implements BaseBean {
    ...
    private SelectBean<GlpFileChange> item;

    public GlpFileChange() {
        this.OnInit();
    }
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((GlpFileChange) item, this, this.OnProperties());
    }
    ...
    public SelectBean<GlpFileChange> getItem() {
        if (item == null)
            item = new SelectBean<GlpFileChange>();

        return item;
    }

    public void setItem(SelectBean<GlpFileChange> item) {
        this.item = item;
    }
