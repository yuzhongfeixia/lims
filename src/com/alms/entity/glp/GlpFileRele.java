...
public class GlpFileRele implements BaseBean {
    ...
    private SelectBean<GlpFileRele> item;
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((GlpFileRele) item, this, this.OnProperties());
    }
    ...
    public SelectBean<GlpFileRele> getItem() {
        if (item == null)
            item = new SelectBean<GlpFileRele>();

        return item;
    }

    public void setItem(SelectBean<GlpFileRele> item) {
        this.item = item;
    }
