...
public class GlpFileLeak implements BaseBean {
    ...
    private SelectBean<GlpFileLeak> item;
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((GlpFileLeak) item, this, this.OnProperties());
    }
    ...
    public SelectBean<GlpFileLeak> getItem() {
        if (item == null)
            item = new SelectBean<GlpFileLeak>();

        return item;
    }

    public void setItem(SelectBean<GlpFileLeak> item) {
        this.item = item;
    }
