...
public class GlpFileNotify implements BaseBean {
    ...
    private SelectBean<GlpFileNotify> item;

    public GlpFileNotify() {
        this.OnInit();
    }
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((GlpFileNotify) item, this, this.OnProperties());
    }
    ...
    public SelectBean<GlpFileNotify> getItem() {
        if (item == null)
            item = new SelectBean<GlpFileNotify>();

        return item;
    }

    public void setItem(SelectBean<GlpFileNotify> item) {
        this.item = item;
    }
