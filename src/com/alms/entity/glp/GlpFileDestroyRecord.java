...
public class GlpFileDestroyRecord implements BaseBean {
    ...
    private SelectBean<GlpFileDestroyRecord> item;

    public GlpFileDestroyRecord() {
        this.OnInit();
    }
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((GlpFileDestroyRecord) item, this, this.OnProperties());
    }
    ...
    public SelectBean<GlpFileDestroyRecord> getItem() {
        if (item == null)
            item = new SelectBean<GlpFileDestroyRecord>();

        return item;
    }

    public void setItem(SelectBean<GlpFileDestroyRecord> item) {
        this.item = item;
    }
