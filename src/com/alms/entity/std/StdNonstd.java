...
public class StdNonstd implements BaseBean {
    ...
    private SelectBean<StdNonstd> item;
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((StdNonstd) item, this, this.OnProperties());
    }

    @Override
    public String[] OnProperties() {
        return new String[] { "业务编号:tranid", "检测方法名称:testmethname", "方法来源:methsource", "理由:reason", "试验记录:trialrecord",
                "提出人:propuser", "提出人姓名:propusername", "提出时间:propdate", "审查人:audituser", "审查人姓名:auditusername",
                "审查时间:auditdate", "业务动作:flowaction", "业务动作名称:flowactionname", "业务状态:flowstatus",
    ...
    public String getTestmethname() {
        return testmethname;
    }

    public void setTestmethname(String testmethname) {
        this.testmethname = testmethname;
    }

    public String getMethsource() {
        return methsource;
    }

    public void setMethsource(String methsource) {
        this.methsource = methsource;
    }
    ...
    public SelectBean<StdNonstd> getItem() {
        if (item == null)
            item = new SelectBean<StdNonstd>();

        return item;
    }

    public void setItem(SelectBean<StdNonstd> item) {
        this.item = item;
    }
