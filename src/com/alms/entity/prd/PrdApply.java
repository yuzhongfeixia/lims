...
public class PrdApply implements BaseBean {
    ...
    // 耗材来源名称
    private String prdsourcename;

    private SearchParams search;

    private DataDeal deal;

    private SelectBean<PrdApply> item;
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((PrdApply) item, this, this.OnProperties());
    }

    @Override
    public String[] OnProperties() {
        return new String[] { "业务编号:tranid", "使用项目:projectid", "耗材类别:prdtype", "耗材分类名称:prdtypename", "业务动作:flowaction",
                ...
                "室主任确认日期:confirmdate", "室主任确认意见:confirmdesc", "经费渠道:fundsource", "办公室审核人:audituser",
                "办公室审核人姓名:auditusername", "办公室审核日期:auditdate", "办公室审核意见:auditdesc", "分管主任审批人:checkuser",
                "分管主任审批人姓名:checkusername", "分管主任审核日期:checkdate", "分管主任审批意见:checkdesc", "主任:agreeuser",
                "主任姓名:agreeusername", "签字时间:agreedate", "特殊要求说明:tranremark" };
    }
    ...
    public String getPrdsourcename() {
        return prdsourcename;
    }

    public void setPrdsourcename(String prdsourcename) {
        this.prdsourcename = prdsourcename;
    }
    ...
    public SelectBean<PrdApply> getItem() {
        if (item == null)
            item = new SelectBean<PrdApply>();

        return item;
    }

    public void setItem(SelectBean<PrdApply> item) {
        this.item = item;
    }
