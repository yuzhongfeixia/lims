...
public class IncFileOnline implements BaseBean {
    ...
    private SelectBean<IncFileOnline> item;

    public IncFileOnline() {
        this.OnInit();
    }
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((IncFileOnline) item, this, this.OnProperties());
    }
    ...
    public SelectBean<IncFileOnline> getItem() {
        if (item == null)
            item = new SelectBean<IncFileOnline>();

        return item;
    }

    public void setItem(SelectBean<IncFileOnline> item) {
        this.item = item;
    }
