...
public class DestoryApplyDetail implements BaseBean {
    ...
    private SelectBean<DestoryApplyDetail> item;

    public DestoryApplyDetail() {
        this.OnInit();
    }
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((DestoryApplyDetail) item, this, this.OnProperties());
    }
    ...
    public SelectBean<DestoryApplyDetail> getItem() {
        if (item == null)
            item = new SelectBean<DestoryApplyDetail>();

        return item;
    }

    public void setItem(SelectBean<DestoryApplyDetail> item) {
        this.item = item;
    }
