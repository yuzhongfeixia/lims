...
public class IncFileRegister implements BaseBean {
    ...
    private SelectBean<IncFileRegister> item;

    public IncFileRegister() {
        this.OnInit();
    }
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((IncFileRegister) item, this, this.OnProperties());
    }
    ...
    public SelectBean<IncFileRegister> getItem() {
        if (item == null)
            item = new SelectBean<IncFileRegister>();

        return item;
    }

    public void setItem(SelectBean<IncFileRegister> item) {
        this.item = item;
    }
