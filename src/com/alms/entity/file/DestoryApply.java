...
public class DestoryApply implements BaseBean {
    ...
    private SelectBean<DestoryApply> item;
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((DestoryApply) item, this, this.OnProperties());
    }
    ...
    public SelectBean<DestoryApply> getItem() {
        if (item == null)
            item = new SelectBean<DestoryApply>();

        return item;
    }

    public void setItem(SelectBean<DestoryApply> item) {
        this.item = item;
    }
