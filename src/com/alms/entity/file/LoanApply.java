...
public class LoanApply implements BaseBean {
    ...
    private SelectBean<LoanApply> item;
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((LoanApply) item, this, this.OnProperties());
    }
    ...
    public SelectBean<LoanApply> getItem() {
        if (item == null)
            item = new SelectBean<LoanApply>();

        return item;
    }

    public void setItem(SelectBean<LoanApply> item) {
        this.item = item;
    }
