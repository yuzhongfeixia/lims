...
public class BusTaskAttach implements BaseBean {
    ...
    private SelectBean<BusTaskAttach> item;

    public BusTaskAttach() {
        this.OnInit();
    }
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((BusTaskAttach) item, this, this.OnProperties());
    }
    ...
    public SelectBean<BusTaskAttach> getItem() {
        if (item == null)
            item = new SelectBean<BusTaskAttach>();

        return item;
    }

    public void setItem(SelectBean<BusTaskAttach> item) {
        this.item = item;
    }
