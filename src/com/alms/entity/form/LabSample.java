...
public class LabSample implements BaseBean {
    ...
    private SelectBean<LabSample> item;
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((LabSample) item, this, this.OnProperties());
    }
    ...
    public SelectBean<LabSample> getItem() {
        if (item == null)
            item = new SelectBean<LabSample>();

        return item;
    }

    public void setItem(SelectBean<LabSample> item) {
        this.item = item;
    }
}
