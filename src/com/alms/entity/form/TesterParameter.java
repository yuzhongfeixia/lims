...
public class TesterParameter implements BaseBean {
    ...
    private SelectBean<TesterParameter> item;

    public TesterParameter() {
        this.OnInit();
    }
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((TesterParameter) item, this, this.OnProperties());
    }
    ...
    public SelectBean<TesterParameter> getItem() {
        if (item == null)
            item = new SelectBean<TesterParameter>();

        return item;
    }

    public void setItem(SelectBean<TesterParameter> item) {
        this.item = item;
    }
}
