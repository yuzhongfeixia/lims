...
public class FrmGetDetail implements BaseBean {
    ...
    private SelectBean<FrmGetDetail> item;
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((FrmGetDetail) item, this, this.OnProperties());
    }
    ...
    public SelectBean<FrmGetDetail> getItem() {
        if (item == null)
            item = new SelectBean<FrmGetDetail>();

        return item;
    }

    public void setItem(SelectBean<FrmGetDetail> item) {
        this.item = item;
    }
