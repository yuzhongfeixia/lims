...
public class SamplePass implements BaseBean {
    ...
    private SelectBean<SamplePass> item;
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((SamplePass) item, this, this.OnProperties());
    }
    ...
    public SelectBean<SamplePass> getItem() {
        if (item == null)
            item = new SelectBean<SamplePass>();

        return item;
    }

    public void setItem(SelectBean<SamplePass> item) {
        this.item = item;
    }
}
