...
public class FrmRecordDetail implements BaseBean {
    ...
    private SelectBean<FrmRecordDetail> item;
    ...
    public String OnCompare(BaseBean item) throws Exception {
        return ToolUtils.CompareProperty((FrmRecordDetail) item, this, this.OnProperties());
    }
    ...
    public String[] OnProperties() {
        return new String[] { "表单编号:formid", "序号:cellserial", "开始行数:beginrow", "开始列数:endrow", "结束行数:begincolumn",
                ...
                "对齐方式:aligntype", "前缀:prefixtext", "后缀:postfixtext", "组号:groupserial", "试件号:specserial",
                "所属类编号:classsource", "所属类名称:classsourcename", "类字段编号:fieldcode" };
    }
    ...
    public SelectBean<FrmRecordDetail> getItem() {
        if (item == null)
            item = new SelectBean<FrmRecordDetail>();

        return item;
    }

    public void setItem(SelectBean<FrmRecordDetail> item) {
        this.item = item;
    }
